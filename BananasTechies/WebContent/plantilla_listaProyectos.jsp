...
<li class="box1 linkBox col-xs-12 col-sm-7" id="project1Id">
		...
		<div class="col-xs-12 col-sm-5">
			<div class="buttons">
				<a href="#" class="btn_del_Project btn glyphicon glyphicon-trash"
					data_Id="project1Id" aria-label="botonBorrarP">
					<span class="iconText"> Borrar</span>
				</a>
			</div>
			<div class="buttons">
				<a href="project.html" class="btn glyphicon glyphicon-eye-open"
					aria-label="Tareas">
					<span class="iconText"> Ver</span>
				</a>
			</div>
			<div class="buttons">
				<a href="taskList.html" class="btn glyphicon glyphicon-tasks"
					aria-label="Tareas">
					<span class="iconText"> Ver Tareas</span>
				</a>
			</div>
		</div>
	</a>
